 ...
 */
export declare const getResolvedPath: (path: string, importer?: string) => string;
/**
 ...
 */
export declare const getFile: (path: string, type?: 'string' | 'buffer', importer?: string) => string | Uint8Array;
/**
 ...
 * @param importer an absolute path to use to determine a relative file path
 */
export declare const setFile: (path: string, content: Uint8Array | string, importer?: string) => void;
