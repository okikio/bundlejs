...
(function(X) {
  ((pe) => {
    ...
    function Oe(t) {
      ...
      return r.write32(0), r.write32(t.id << 1 | +!t.isRequest), n(t.value), Se(r.buf, r.len - 4, 0), r.buf.subarray(0, r.len);
    }
    function Qe(t) {
      let n = () => {
        switch (r.read8()) {
    ...
    var Pe = class {
      ...
      write(t) {
        ...
        Se(this.buf, t.length, n), this.buf.set(t, n + 4);
      }
      _read(t) {
    ...
    if (typeof TextEncoder < "u" && typeof TextDecoder < "u") {
      ...
      K = (r) => t.encode(r), ae = (r) => n.decode(r), $e = 'new TextEncoder().encode("")';
...
`);
    ...
    function rt(t, n, r, c, m) {
      ...
      if (f.plugins = !0, W(n, f, `in ${t}() call`), D && u.push(`--sourcemap${D === !0 ? "" : `=${D}`}`), S && u.push("--bundle"), ge && u.push("--allow-overwrite"), R)
        if (u.push("--watch"), typeof R == "boolean")
          ...
          let E = /* @__PURE__ */ Object.create(null), B = i(R, E, "onRebuild", je);
    ...
    var ot = (t, n, r, c, m, g, u) => {
      let v = {}, f = i(g, v, "port", ue), k = i(g, v, "host", $), T = i(g, v, "servedir", $), P = i(g, v, "onRequest", je), D = new Promise((S, R) => {
        m["serve-wait"] = (x, A) => {
...
const St = /* @__PURE__ */ kt(ke), jt = /* @__PURE__ */ Et({
  __proto__: null,
  default: St
}, [ke]);
export {
...
//# sourceMappingURL=esbuild-e276c716.mjs.map
