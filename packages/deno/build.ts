...
import type { BundleConfigOptions, CompressionOptions } from "./configs/options.ts";
import type { PLATFORM } from "./configs/platform.ts";

import ESBUILD_WASM from "./wasm.ts";
import { version } from "esbuild-wasm";

import bytes from "bytes";

import { gzip, getWASM } from "./deno/denoflate/mod.ts";
import { compress } from "./deno/brotli/mod.ts";
import { compress as lz4_compress } from "./deno/lz4/mod.ts";
...
import { STATE } from "./configs/state.ts";
