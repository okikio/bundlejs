...
import { EasyDefaultConfig } from "../configs/options.js";
import { deepAssign } from "./deep-equal.js";
/**
 ...
 */
export const parseTreeshakeExports = (str) => (str ?? "").split(/\],/).map((str) => str.replace(/\[|\]/g, ""));
...
*/
export const parseShareQuery = (shareURL) => {
    try {
...
*/
export const parseConfig = (shareURL) => {
    try {
        const searchParams = shareURL.searchParams;
