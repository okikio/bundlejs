 ...
 */
export const getCDNStyle = (urlStr) => {
 ...
 */
export const getCDNOrigin = (importStr, cdn = DEFAULT_CDN_HOST) => {
 ...
 */
export const getPureImportPath = (importStr) => importStr
 ...
 */
export const getCDNUrl = (importStr, cdn = DEFAULT_CDN_HOST) => {
