...
exports.ansi = exports.render = exports.AnsiBuffer = exports.htmlEscape = exports.ESCAPE_TO_COLOR = void 0;
...
function render(ansi) {
    ...
    for (let m of ansi.matchAll(/\x1B\[([\d;]+)m/g)) {
        ...
        else if (exports.ESCAPE_TO_COLOR[escape]) {
            buffer.color(exports.ESCAPE_TO_COLOR[escape]);
        }
    }
    if (i < ansi.length) {
