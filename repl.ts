import { encode, decode } from "./packages/old/old-src/ts/util/encode-decode";
import { compress } from "./packages/old/old-src/ts/deno/lz4/mod";
import { gzip, getWASM } from "./packages/old/old-src/ts/deno/denoflate/mod";
import { compress as brotli } from "./packages/old/old-src/ts/deno/brotli/mod";
